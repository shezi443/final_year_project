...
@InputType()
class ReservationCreateNestedManyWithoutListingsInput {
...
export { ReservationCreateNestedManyWithoutListingsInput as ReservationCreateNestedManyWithoutListingsInput };
